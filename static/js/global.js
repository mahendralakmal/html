...
// Hide/Show script //
	$(document).ready( function() {
		...
		$('.hide-show-expand').each(function (n, e) {
            $(this).after("<div class=\"hide-show\"><p>Show more</p></div>");
    	});
		$(".hide-show").click(function() {
			$(this).toggleClass('ui-state-active').prev('.hide-show-expand').slideToggle(900);	
			var text = $("p", this).text();
			$("p", this).text(text == "Show more" ? "Show less" : "Show more");
			return false;
	});	
});